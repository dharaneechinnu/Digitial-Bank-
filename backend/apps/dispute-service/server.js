/**
 * Dispute Service Server
 * Transaction dispute and chargeback management service
 */
...
// Ensure shared and service node_modules are resolvable from shared code
{
  ...
  Module.globalPaths.push('/app/apps/dispute-service/node_modules');
}

const app = require('./app');
const config = require('../../shared/config');

const PORT = config.app.ports.disputeService || 8007;
